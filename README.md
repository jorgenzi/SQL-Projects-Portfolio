...
О проекте
Этот репозиторий — портфолио выполненных заданий по углублённому изучению SQL на примере учебной базы данных пиццерий.
Что внутри:
✅ 9 тематических модулей с нарастающей сложностью
✅ 70+ практических заданий с решениями
✅ Реальные кейсы: аналитика, оптимизация, бизнес-логика
✅ Чистый SQL + расширения PostgreSQL (CTE, оконные функции, триггеры)
